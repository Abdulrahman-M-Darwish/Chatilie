...
export const NoPosts: React.FC<Props> = ({ message, children }) => {
  return (
    <div className="my-auto flex items-center flex-col">
      ...
      >
        ...
        <ellipse
          ...
          fill="oklch(var(--p))"
        />
        <circle cx="496" cy="301.5" r="301.5" fill="oklch(var(--p))" />
        ...
        <path
          ...
          fill="oklch(var(--n))"
        />
        <circle cx="559" cy="744.5" r="43" fill="oklch(var(--p))" />
        <circle cx="54" cy="729.5" r="43" fill="oklch(var(--p))" />
        <circle cx="54" cy="672.5" r="31" fill="oklch(var(--p))" />
        <circle cx="54" cy="624.5" r="22" fill="oklch(var(--p))" />
      </svg>
      <p className="text-xl mt-2 font-bold">
        {message || 'No Posts Make Posts, Friends Or Life'}
      </p>
      {children}
    </div>
  );
